          ...
          for ientry, entry in enumerate(effect):
            ...
            if "flatten" in self.systs[syst]:
              for ibin in range(1, self.nbins+1):
                ...
                print("After scaling, yields are %s(%s)=%1.3f, %s(%s)=%1.3f"%(str(ibin) + "_" + ss + syst + "Up", self.th1s_perbin[ibin][ss + syst + "Up"].GetName(), self.th1s_perbin[ibin][ss + syst + "Up"].GetBinContent(1) , str(ibin) + "_" + ss + syst + "Dwown", self.th1s_perbin[ibin][ss + syst + "Down"].GetName(), self.th1s_perbin[ibin][ss + syst + "Down"].GetBinContent(1)))
