...
main_path_signal = "/eos/cms/store/user/gdecastr/HDF5s_NewSigs/2017/" #"/eos/cms/store/group/phys_exotica/SUEPs/UL17/hdf5_withJECs/"
...
samples = {
  ...
  "WW": {
         ...
         "skim"       : "/eos/cms/store/group/phys_exotica/SUEPs/UL17/skim_2l_20_10/WWTo2L2Nu/skims.root",
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"]*x["LepSF"],
  },
  "WZ2l2q": {
...
for sample in samples:
  ...
  "Track": {
           ...
           "transposer"      :  lambda x: transposeTracks(x, "UL17","leadcluster_ntracks"),
           "symmetrize"      : False
    },
}
